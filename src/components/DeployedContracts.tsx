    ...
    >
      <div className="flex justify-between items-baseline gap-4 max-lg:flex-col">
        <div>
          ...
          >
            Every verdict on The Jury is reached by GenLayer validators on these
            deployed intelligent contracts. Click any address to inspect the
            contract on-chain.
          </p>
        </div>
        <div
          className="font-[family-name:var(--font-mono)] text-[11px] uppercase tracking-[0.15em]"
      ...
      <div className="grid grid-cols-2 gap-6 mt-10 max-lg:grid-cols-1">
        <a
          href={
            flightAddress ? explorerAddressUrl(flightAddress) : EXPLORER_BASE
          }
          target="_blank"
        ...
        >
          ...
          <div
            className="mt-3 font-[family-name:var(--font-mono)]"
        ...
        <a
          href={
            disputeAddress ? explorerAddressUrl(disputeAddress) : EXPLORER_BASE
          }
          target="_blank"
          rel="noopener noreferrer"
          className="border p-6 no-underline"
